...
function Adduser() {
    ...
    const [profileMode, setProfileMode] = useState(''); // State for profile mode
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('profile_mode', profileMode); // Add profile mode to form data
        if (image) {
            formData.append('image', image); // Add image file if it exists
        }
