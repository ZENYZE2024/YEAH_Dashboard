...
const CouponForm = () => {
    ...
    const handleSave = async (coupon) => {
        const { coupon_id, coupon_code, discount_type, min_amount, max_amount, expiry_date, emails } = coupon;
        const couponData = {
            ...
            isActive: coupon.is_active ? 1 : 0, // Convert to boolean for DB
                        ...
                        <li key={coupon.coupon_id} className="border border-gray-300 rounded-lg p-4">
                            {coupon.isEditing ? (
                                ...
                                <div>
                                    ...
                                    <p><strong>Max Amount:</strong> {coupon.max_amount}</p>
                                    ...
                                    {coupon.emails && <p><strong>Emails:</strong> {coupon.emails}</p>}
                                    <button
